    ...
    (t.matchMedia =
        ...
        (t.Foundation = {
                    ...
                    ? (this.patch(this.libs[t]),
                      n && n.hasOwnProperty(t)
                          ? (typeof this.libs[t].settings != "undefined"
                            ...
                            this.libs[t].init.apply(this.libs[t], [
                                this.scope,
                                n[t],
                            ]))
            ...
            inherit: function (e, t) {
                var n = t.split(" "),
                    r = n.length;
                while (r--)
                    this.utils.hasOwnProperty(n[r]) &&
                        (e[n[r]] = this.utils[n[r]]);
            },
            set_namespace: function () {
                var t =
                    this.global.namespace === r
                        ? e(".foundation-data-attribute-namespace").css(
                              "font-family"
                          )
        ...
        (e.fn.foundation = function () {
            ...
            return this.each(function () {
                return (
                    Foundation.init.apply(Foundation, [this].concat(e)), this
                );
            });
        });
        ...
        Foundation.libs.interchange = {
                ...
                directives: {
                    replace: function (t, n, r) {
                        ...
                        return /\.(gif|jpg|jpeg|tiff|png)([?#].*)?/i.test(n)
                            ...
                            : e.get(n, function (e) {
                                  t.html(e),
                                      t.data(o.data_attr + "-last-path", n),
                                      r();
                              });
                    },
                },
            ...
            update_images: function () {
                ...
                while (n--) {
                    ...
                    r === t &&
                        ((this.images_loaded = !0), this.enhance("images"));
                }
                return this;
            },
            update_nodes: function () {
                ...
                while (n--) {
                    ...
                    s.length > 0 && this.cached_nodes.push(e[n]),
                        r === t &&
                            ((this.nodes_loaded = !0), this.enhance("nodes"));
                }
                return this;
            },
            enhance: function (n) {
            ...
            store: function (e, t) {
                ...
                return this.cache[r]
                    ? this.cache[r]
                    : (e.attr(this.add_namespace("data-uuid"), n),
                      (this.cache[n] = t));
            },
            trim: function (t) {
                return typeof t == "string" ? e.trim(t) : t;
            ...
            open: function (t, n) {
                ...
                t
                    ? typeof t.selector != "undefined"
                        ? (i = r
                              .S("#" + t.data(r.data_attr("reveal-id")))
                              .first())
                ...
                if (!i.hasClass("open")) {
                    ...
                    if (typeof n == "undefined" || !n.url)
                        o.length > 0 && this.hide(o, s.css.close),
                            this.show(i, s.css.open);
                    else {
                        var u =
                            typeof n.success != "undefined" ? n.success : null;
                        e.extend(n, {
