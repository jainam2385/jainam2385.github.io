(function (c, b, e) {
    ...
    c.CBPFWSlider.defaults = { speed: 500, easing: "ease" };
    c.CBPFWSlider.prototype = {
        ...
        _config: function () {
            ...
            if (this.support) {
                this.transEndEventName =
                    h[d.prefixed("transition")] + ".cbpFWSlider";
            ...
            if (this.itemsCount > 1) {
                ...
                c("<nav/>")
                    .append(this.$navPrev, this.$navNext)
                    .appendTo(this.$el);
                var l = "";
        ...
        _initEvents: function () {
            ...
            if (this.itemsCount > 1) {
                this.$navPrev.on(
                    "click.cbpFWSlider",
                    c.proxy(this._navigate, this, "previous")
                );
                this.$navNext.on(
                    "click.cbpFWSlider",
                    c.proxy(this._navigate, this, "next")
                );
        ...
        _toggleNavControls: function () {
            ...
            this.$navDots
                .eq(this.old)
                .removeClass("cbp-fwcurrent")
                .end()
                .eq(this.current)
                .addClass("cbp-fwcurrent");
        },
        _jump: function (f) {
    ...
    c.fn.cbpFWSlider = function (g) {
        if (typeof g === "string") {
            ...
            this.each(function () {
                ...
                if (!h) {
                    a(
                        "cannot call methods on cbpFWSlider prior to initialization; attempted to call method '" +
                            g +
                            "'"
                    );
                    return;
