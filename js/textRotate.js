...
new stepsForm(theForm, {
    onSubmit: function (form) {
        ...
        var link = "https://jainam102.herokuapp.com/";
        jQuery.ajax({
            url: link,
            data: {
                name: $("#q2").val(),
        ...
        $(window).scroll(function () {
            if ($(".numbers-wrapper").is(":visible") == true) {
                ...
                $("#coded-lines").animateNumber(
                    { number: 160000, numberStep: comma_separator_number_step },
                    2000
                );
...
function changeImage() {
    ...
    window.open(
        "https://docs.google.com/uc?authuser=0&id=1CDK1CAJXiDgerdjE4kqQ6vmrjw_b0Do_&export=download",
        "_blank"
    );
...
//     {
//         header: "INTERESTS",
//         captions: ["Machine", "Web", "PWAs", "Design", "SEO"],
